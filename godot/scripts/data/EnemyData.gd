...
enum Behavior {
	...
	EXPLODE_CLOSE,   # aproxima até distância de gatilho e explode
	SUMMONER,        # spawna runners periodicamente
...
@export var silhouette: String = "blob"  # blob | tall | wide | crown | mask | skull
